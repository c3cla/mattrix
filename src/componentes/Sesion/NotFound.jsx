...
const NotFound = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      stars.forEach(star => {
        ...
        star.x += (star.x - centerX) * star.speed / 100;
        star.y += (star.y - centerY) * star.speed / 100;
  ...
  return (
    <div className="space-container">
      <canvas ref={starfieldRef} className="starfield" width={window.innerWidth} height={window.innerHeight} />
      <div className="content">
        <svg xmlns="http://www.w3.org/2000/svg" id="planet" viewBox="0 0 512 512" className="planet">
          <circle cx="256" cy="256" r="149.536" fill="#FF4F54" className="saturn" />
          <g fill="#EA4753" className="saturn-2">
          ...
          <circle cx="319.166" cy="208.081" r="28.389" fill="#D83A4E" className="hover" />
          ...
          <circle cx="234.463" cy="273.978" r="19.358" fill="#D83A4E" className="hover" />
          ...
          <circle cx="307.493" cy="144.207" r="12.584" fill="#D83A4E" className="hover" />
          ...
          <circle cx="163.289" cy="255.495" r="19.358" fill="#D83A4E" className="hover" />
          ...
          <circle cx="230.586" cy="365.92" r="19.358" fill="#D83A4E" className="hover" />
          ...
          <circle cx="302.221" cy="353.781" r="19.357" fill="#D83A4E" className="hover" />
          ...
          <circle cx="358.827" cy="284.847" r="11.079" fill="#D83A4E" className="hover" />
          ...
          <circle cx="220.465" cy="156.416" r="11.079" fill="#D83A4E" className="hover" />
          ...
          <circle cx="154.027" cy="171.743" r="5.819" fill="#D83A4E" className="hover" />
          ...
          <circle cx="391.387" cy="251.305" r="5.819" fill="#D83A4E" className="hover" />
          ...
          <circle cx="145.077" cy="302.473" r="5.819" fill="#D83A4E" className="hover" />
          ...
          <circle cx="187.342" cy="355.265" r="5.819" fill="#D83A4E" className="hover" />
        ...
        <p className="subtitle">Houston, tenemos un problema!</p>
        <p className="description">La pagina que buscas se perdio en el espacio.</p>
        <a href="/" className="home-button">Regresa a la tierra</a>
      </div>
    </div>
  );
};
